...
def handler(event):
    ...
    # Crie uma instância do ValidadorJSON
    validador = ValidateJSON(event)

    # Valida o evento
    evento_valido = validador.validate_events()
    print(f"O evento pode seguir para a fila de dados? {evento_valido}")
